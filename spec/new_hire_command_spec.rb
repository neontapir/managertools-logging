...
RSpec.describe NewHireCommand do
  context 'existing team member' do
    ...
    it 'creates a new team member' do
      ...
      expect(File.exist? File.join(starfire_folder, 'overview.adoc')).to be_falsey
      ...
      expect(File.exist? File.join(starfire_folder, 'log.adoc')).to be_truthy
      expect(File.exist? File.join(starfire_folder, 'overview.adoc')).to be_truthy
  ...
  context 'force overwrites team member' do
    ...
    def setup_new_hire_with_o3_entry
      ...
      expect(File.exist? File.join(robin_folder, 'log.adoc')).to be_truthy
      expect(File.exist? File.join(robin_folder, 'overview.adoc')).to be_truthy
