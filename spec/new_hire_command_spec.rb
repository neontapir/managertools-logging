...
RSpec.describe NewHireCommand do
  context 'when hiring' do
    ...
    context 'a new team member (Kid Flash)' do
      let(:kid_flash_folder) { File.join %W[#{Settings.root} teen-titans wally-west] }
    ...
    context 'a new team member with data (Beast Boy)' do
      let (:beast_boy_folder) { File.join %W[#{Settings.root} teen-titans garfield-logan] }
    ...
    context 'with force overwrite of an existing member (Robin)' do
      ...
      let(:robin_folder) { File.join %W[#{Settings.root} teen-titans dick-grayson] }
