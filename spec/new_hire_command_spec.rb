...
RSpec.describe NewHireCommand do
  context 'existing team member' do
    ...
    it 'creates a new team member' do
      expect(File).not_to exist File.join(starfire_folder, 'log.adoc')
      expect(File).not_to exist File.join(starfire_folder, 'overview.adoc')
      ...
      expect(starfire.file.path).to eq File.join(starfire_folder, 'log.adoc')
      expect(File).to exist File.join(starfire_folder, 'log.adoc')
      expect(File).to exist File.join(starfire_folder, 'overview.adoc')
  ...
  context 'force overwrites team member' do
    ...
    def setup_new_hire_with_o3_entry
      ...
      expect(robin.file.path).to eq File.join(robin_folder, 'log.adoc')
      expect(File).to exist File.join(robin_folder, 'log.adoc')
      expect(File).to exist File.join(robin_folder, 'overview.adoc')
