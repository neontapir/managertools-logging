...
describe MtDataFormatter do
  ...
  context "when wrapping a string" do
    ...
    LOREM = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc egestas imperdiet aliquet. Morbi posuere convallis risus, vitae iaculis felis tincidunt sit amet."
